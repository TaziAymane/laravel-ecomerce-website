        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="quantity" class="form-control" placeholder="Enter product quantity" value="{{ old('quantity')}}">
                </div>

                {{-- Price --}}
                <div class="mb-3">
                    <label class="form-label">Price</label>
                    <input type="number" step="0.01" name="price" class="form-control" placeholder="Enter price (e.g. 49.99)" value="{{ old('price')}}">
                </div>
